...
class Book(models.Model):
    ...
    contributors = models.ManyToManyField('Contributor', through='BookContributor')  # MANY TO MANY RELATIONSHIP
...
class Contributor(models.Model):
    ...
    def initialled_name(self):
        first_names_initialled = ''.join([obj[0] for obj in self.first_names.split(' ')])
        return self.last_names + ', ' + first_names_initialled
...
class Review(models.Model):
    ...
    def __str__(self):
        return f'{self.creator}: {self.book}'